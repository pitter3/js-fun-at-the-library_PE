...
var sequel = title + `: The Lost Pages`;
...
if (pages < 1000) {
    console.log(`I can read that in a day!`);
} else {
...
var belowTwoHundred = [199, 42, 24, 56, 108, 146, 144, 1, 13, 64, 33, 77]
// PE: why 12, do you hate us?

// Write the code to access the 5th element of the array, using bracket notation.

belowTwoHundred[4];

// PE: Bobby and I figured we didn't need to log these last questions to the console
// the task is to access the info, not print it.
